...
| :--- |:---:|
| [1](https://github.com/securesandesh/1---Conduct-an-Audit/blob/main/README.md) - Conduct a security audit | `INFOSEC`, `NIST Risk Management Framework`, `Security Audits`, `NIST Cybersecurity Framework`, `Incident Response Playbooks`, `CISSP`, `CIA triad` |
| [2](https://github.com/securesandesh/Network-Security/blob/main/README.md)  - Network Security | `TCP/IP model`,  `Network Architecture`, `Network Communication`, `Security Hardening`, `Network Security`, `Cloud Networks` | 
| [3](https://github.com/securesandesh/3.-Linux-SQL/blob/main/Linux%20&%20SQL.md) - Linux & SQL | `Command-line Interface`, `SQL`, `Linux`, `Bash` | 
